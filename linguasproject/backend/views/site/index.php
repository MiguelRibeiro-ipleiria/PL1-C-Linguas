...
$totalAudios = AudioResource::find()->count();
$totalAudiosex = Audio::find()->count();
$totalImagemsex = Imagem::find()->count();
$totalFraseex = Frase::find()->count();
$totalExercicios = $totalImagemsex + $totalAudiosex + $totalFraseex;
