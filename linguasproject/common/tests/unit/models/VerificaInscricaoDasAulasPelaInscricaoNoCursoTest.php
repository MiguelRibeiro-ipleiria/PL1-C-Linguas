...
class VerificaInscricaoDasAulasPelaInscricaoNoCursoTest extends \Codeception\Test\Unit
{

    protected UnitTester $tester;

    public function testVerificaInscricaoNasAulasSemHaverAulas()
    {
        $idioma = new Idioma();
        ...
        /*Não existem aulas no curso á qual ele se está a tentar inscrever, portanto retorna false*/

        $resultado = Inscricao::inscricaonasaulas($curso->id, $utilizador->id);
        $this->assertFalse($resultado);
    }

    public function testVerificaInscricaoNasAulasComAulasCriadas()
    {
        $idioma = new Idioma();
        $idioma->lingua_descricao = "Português";
        $idioma->data_criacao = date("Y-m-d H:i:s");
    ...
    public function testVerificaInscricaoFalhaComParametrosNulos()
    {
        $resultado = Inscricao::inscricaonasaulas(null, null);
        $this->assertFalse($resultado);
    }
