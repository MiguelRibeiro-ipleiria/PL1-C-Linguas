...
class VerificaNumeroExerciciosAulaTest extends \Codeception\Test\Unit
{
    ...
    public function testVerificaNumeroIncorretoExerciciosAula()
    {
        ...
        $this->assertTrue($tipo_exercicio->save());
        ...
        $this->assertTrue($opcao_1_frase_um->save());
        ...
        $this->assertTrue($opcao_2_frase_um->save());
        ...
        $this->assertTrue($opcao_3_frase_um->save());
        ...
        $this->assertTrue($opcao_4_frase_um->save());
        ...
        $this->assertTrue($frase_dois->save());
        ...
        $this->assertTrue($opcao_1_frase_dois->save());
        ...
        $this->assertTrue($opcao_2_frase_dois->save());
        ...
        $this->assertTrue($opcao_3_frase_dois->save());
        ...
        $this->assertTrue($opcao_4_frase_dois->save());
    ...
    public function testCountDosExerciciosDaAulaFalhaComParametroNulo()
    {
        $idioma = new Idioma();
        $idioma->lingua_descricao = "Português";
        $idioma->data_criacao = date("Y-m-d H:i:s");
        ...
        $resultado = $aula->VerificaNumeroDeExercicios(null);
