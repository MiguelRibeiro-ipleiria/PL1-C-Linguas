...
class Feedback extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['assunto_feedback', 'descricao_feedback', 'hora_criada', 'utilizador_id'], 'required', 'message' => 'Este campo é obrigatório.'],
            [['hora_criada'], 'safe'],
            [['utilizador_id'], 'integer'],
            [['assunto_feedback', 'descricao_feedback'], 'string', 'max' => 45],
